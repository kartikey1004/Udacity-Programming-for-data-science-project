...
def choice(prompt, choices=('y', 'n')):
    ...
    while True:
        ...
        prompt = ("\nOops!, Something is not right. Please mind the formatting and "
...
def get_filters():
    ...
    while True:
        city = choice("\nFor which city do you want do select data, "
                      "New York City, Chicago or Washington?\n ", CITY_DATA.keys())

        month = choice("\nFrom January to June, for which month(s) do you want do filter data? \n  "
                       "Use commas to choose multiple months.\n>",
                       months)
        day = choice("\nFor which day(s) of the week do you want to filter the data? "
                     "Use commas to choose multiple days.\n>", weekdays)
